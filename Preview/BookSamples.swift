    ...
    static var sampleBooks: [Book] {
        [
            ...
            Book(title: "Eden",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "W powieści „Eden” grupa naukowców wyrusza na obcą planetę Eden, aby zbadać jej egzotyczną florę i faunę. Podczas misji badawczej odkrywają tajemnicze zjawiska i starożytne artefakty, które zmuszają ich do przewartościowania swoich przekonań na temat natury życia i świata. Lem eksploruje w tej książce różnice między ludzkim a obcym sposobem myślenia oraz nasze miejsce w kosmicznym ekosystemie.",
                 rating: 4,
                 status: Status.inProgress),
            ...
            Book(title: "Dzienniki gwiazdowe",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "„Dzienniki gwiazdowe” to zbiór esejów, w których Lem reflektuje nad przyszłością technologii, eksploracją kosmosu i ewolucją ludzkości. Autor prowadzi czytelnika przez filozoficzne rozważania na temat istoty życia, inteligencji i cywilizacji. Lem stawia pytania o naszą rolę jako gatunku w kosmosie oraz naszą zdolność do zrozumienia wszechświata.",
                 rating: 5,
                 status: Status.inProgress),
            ...
            Book(title: "Heban",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "W „Hebanie” Kapuściński relacjonuje swoje podróże do Afryki, przedstawiając barwne opowieści o różnych kulturach i miejscach, które odwiedził. Książka stanowi mieszankę reportażu, podręcznika geografii i eseju, ukazując niezwykłą różnorodność kontynentu afrykańskiego.",
                 rating: 5,
                 status: Status.inProgress),
            ...
            Book(title: "Szachinszach",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "W „Szachinszachu” Kapuściński opisuje wybuch rewolucji islamskiej w Iranie w 1979 roku, która obaliła monarchię Pahlawich. Książka prezentuje portret szacha Mohammad Rezy Pahlawiego oraz analizuje przyczyny i skutki rewolucji, ukazując zarówno losy przywódcy, jak i zwykłych mieszkańców kraju.",
                 rating: 4,
                 status: Status.inProgress),
            ...
            Book(title: "Imperium",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "„Imperium” to podróżnicze eseje Kapuścińskiego, które opisują życie w krajach byłego Związku Radzieckiego po jego rozpadzie. Autor ukazuje skomplikowane procesy polityczne i społeczne, które miały miejsce po upadku imperium sowieckiego, ukazując jednocześnie ludzkie tragedie i nadzieje.",
                 rating: 4,
                 status: Status.inProgress),
            ...
            Book(title: "Afryka",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "W „Afryce” Kapuściński przedstawia różne oblicza kontynentu afrykańskiego, zwracając uwagę na jego bogactwo kulturowe i historyczne. Książka skupia się na codziennym życiu mieszkańców Afryki, ukazując ich wyjątkowe zwyczaje, wierzenia i dążenia do lepszej przyszłości.",
                 rating: 5,
                 status: Status.inProgress),
            ...
            Book(title: "Lapidarium",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "„Lapidarium” to zbiór esejów Kapuścińskiego, które ukazują różne aspekty polityki, historii i kultury. Autor analizuje wydarzenia i postacie z różnych części świata, rzucając światło na ich znaczenie i wpływ na ludzkie losy.",
                 rating: 4,
                 status: Status.inProgress),
            ...
            Book(title: "Podróże z Herodotem",
                 ...
                 dateAdded: lastMonth,
                 dateStarted: lastWeek,
                 summary: "W „Podróżach z Herodotem” Kapuściński dzieli się swoimi refleksjami na temat podróży, historii i spotkań z różnymi kulturami. Autor odnosi się do dzieła Herodota, starożytnego historyka, porównując jego własne doświadczenia z podróżami Herodota, ukazując zarówno różnice, jak i wspólne cechy podróży i odkrywania świata.",
                 rating: 5,
                 status: Status.inProgress),
